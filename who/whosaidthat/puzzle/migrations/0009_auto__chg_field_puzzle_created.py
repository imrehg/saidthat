...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Puzzle.created'
        db.alter_column('puzzle_puzzle', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))


    def backwards(self, orm):
        
        # Changing field 'Puzzle.created'
        db.alter_column('puzzle_puzzle', 'created', self.gf('django.db.models.fields.DateTimeField')(null=True))
