...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Puzzle'
        db.create_table('puzzle_puzzle', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('quote', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['puzzle.Quote'], blank=True)),
            ('fakeauth0', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', blank=True, to=orm['puzzle.Person'])),
            ('fakeauth1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', blank=True, to=orm['puzzle.Person'])),
            ('fakeauth2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', blank=True, to=orm['puzzle.Person'])),
            ('totalguess', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('goodguess', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('puzzle', ['Puzzle'])


    def backwards(self, orm):
        
        # Deleting model 'Puzzle'
        db.delete_table('puzzle_puzzle')
